...
function populateGradebook(gradeData) {
    // This function will take the fetched grade data and populate the table
    console.log("Populating gradebook with data:", gradeData);
    let tableElm = document.getElementById("gradebook"); // Get the gradebook table element
        gradeData.forEach(function(assignment){ // For each row of data we're passed in
